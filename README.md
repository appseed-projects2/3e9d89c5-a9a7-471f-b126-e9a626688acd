...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-03-05 15:39`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/3e9d89c5-a9a7-471f-b126-e9a626688acd.git
$ cd 3e9d89c5-a9a7-471f-b126-e9a626688acd
```
